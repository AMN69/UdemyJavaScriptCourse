...
})({"a12dc513ee891431ec7202675f248c46":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "bcec3aeb053e4948f8dce6e9933a1e81";
...
},{}],"325304308b381d5aa79161ff5a7d67c4":[function(require,module,exports) {
require('./bundle-manifest').register(JSON.parse("{\"f8dce6e9933a1e81\":\"controller.bcec3aeb.js\",\"5239ad8e6d97e33a\":\"icons.8d3bb6c1.svg\"}"));
...
const controlRecipes = async function () {
  try {
    ...
    recipeView.renderSpinner(); // AMN - we load the recipe

    await model.loadRecipe(id); // AMN - we render the recipe 
...
['hashchange', 'load'].forEach(event => window.addEventListener(event, _recipeView.default.render())); //theRecipe('https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bc886');
//theRecipe('https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bc90b');
},{"core-js/modules/web.immediate.js":"140df4f8e97a45c53c66fead1f5a9e92","./model.js":"47ecf14258f00bde4534498b74632124","./views/recipeView":"7a075e00040333dc06667640b8596934"}],"140df4f8e97a45c53c66fead1f5a9e92":[function(require,module,exports) {
...
},{"../internals/get-built-in":"a8e7e15d3af5a0a555019aebcf7ed164"}],"47ecf14258f00bde4534498b74632124":[function(require,module,exports) {
"use strict";
...
},{}],"7a075e00040333dc06667640b8596934":[function(require,module,exports) {
"use strict";
...
function _generateMarkup2() {
  ...
  return `
            <figure class="recipe__fig">
                <img src="${_classPrivateFieldGet(this, _data).image}" alt="Recipe image" class="recipe__img" />
                <h1 class="recipe__title">
...
},{"url:../../img/icons.svg":"0e4179be73f37ca15b3c8bc7b994784f"}],"0e4179be73f37ca15b3c8bc7b994784f":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + require('./relative-path')("f8dce6e9933a1e81", "5239ad8e6d97e33a");
...
},{"./bundle-manifest":"ba8df6b71e73837c465d69bebde6e64d"}]},{},["a12dc513ee891431ec7202675f248c46","325304308b381d5aa79161ff5a7d67c4","c5843767b0bc0784c718518d67d386e0"], null)

//# sourceMappingURL=controller.bcec3aeb.js.map
