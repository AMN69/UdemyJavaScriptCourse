...
// AMN - Promise.race() makes that the first promise to end is the winner and gives the fulfillment or reject to the array (unless the Promise.all() that needs all the promises to be fullfilled)
...
//   ]).then(res => console.log("Promise.allSettled response: ", res));
...
//     Promise.resolve('Another success'),
//   ])
//     .then(res => console.log("Promise.all response: ", res))
//     .catch(err => console.error("Promise.all error: ", err));
  
//   // Promise.any [ES2021] - ignores rejected promises
//   Promise.any([
//     Promise.resolve('Success'),
//     Promise.reject('ERROR'),
//     Promise.resolve('Another success'),
//   ])
//     .then(res => console.log("Promise.any response: ", res))
...
//     try {
//         await createImage("/Users/andreumartineznuevo/OneDrive/Andreu/Udemy Javascript course/complete-javascript-course-master/16-Asynchronous/final/img/img-1.jpg")
//         await wait(2)
//         image.style.display = "none"
//         await createImage("/Users/andreumartineznuevo/OneDrive/Andreu/Udemy Javascript course/complete-javascript-course-master/16-Asynchronous/final/img/img-2.jpg") 
//         await wait(2)
//         image.style.display = "none"
//     } catch (err) {
//         console.error(err)
...
const loadAll = async function (imgArr) {
    try {
      const imgs = imgArr.map(async img => await createImage(img)); // AMN - this is an array of promises
      const imgsEl = await Promise.all(imgs); // AMN - we handle the array of promises here in at the same time
      console.log(imgsEl);
